...
//! most often deep yellow to orange in coloration. The thick shell contains the seeds and pulp. T
//! he name is most commonly used for cultivars of Cucurbita pepo, but some cultivars of Cucurbita
...
//! ![These are so many pumpkins!!!](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
...
/// Constant value for the [`orangeness`](Pumpkin::orangeness) property of a [`Pumpkin`].
